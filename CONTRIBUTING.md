...
Ready to contribute? Here's how to set up `Bee_Colony_Dashboard_R` for local development.

1. Download a copy of `Bee_Colony_Dashboard_R` locally.
...
Please note that the `Bee_Colony_Dashboard_R` project is released with a [Contributor Code of
